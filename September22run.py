...
os.chdir("H:\Il mio Drive\WORK\\run0_47V00_20ADC_external_trigger_3V3_20ns")
h1.file="0_wave1_47V00_20ADC_external_trigger_3V3_20ns.dat"
...
#%%
histo_2d(hd[j].t, hd[j].a_filt, x1=0, x2=hd[j].t[0,-1], step1=hd[j].ns, y1=-100, y2=400, step2=4)
#%%  MULTIFIT
