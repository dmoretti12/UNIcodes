...
#%% DATI RANDOM TRIGGER 14/09  [500 wvf x 250000 pt = 500 ms x ch5]
j=0
hd[j].ns = 4
h1 = READ_DATA(hd[j])
...
#%% DATI LED 14/09  [10000 wvf x 5000 pt = 200 ms x ch5]
j=1
hd[j].ns = 4
h1 = READ_DATA(hd[j])
...
h1.file="0_wave5_47V00_20ADC_led_5V_50ns.dat"
hd[j].a_wout_baseline,  hd[j].t, _, _ = h1.__read__()
os.chdir(r"C:\Users\Davide\Documents\GitHub\UNIcodes")
...
h1.file="0_wave1_light_leakage_test_led_flange_covered.dat"
hd[j].a_wout_baseline,  hd[j].t, _, _ = h1.__read__()
os.chdir(r"C:\Users\Davide\Documents\GitHub\UNIcodes")
...
file1="0_wave1_led_7V_50ns_digital_on.dat"
file2="1_wave1_led_7V_50ns_digital_on.dat"
file3="2_wave1_led_7V_50ns_digital_on.dat"
...
# hd[j].a_wout_baseline,  hd[j].t = g1.concatenate(n_file, files)
g1.file="wave2.dat"
hd[j].a_wout_baseline,  hd[j].t, _, _ = g1.__read__()
os.chdir(r"C:\Users\Davide\Documents\GitHub\UNIcodes")
...
# hd[j].a_wout_baseline,  hd[j].t = g1.concatenate(n_file, files)
h1.file="0_wave0_35V00_100ADC_externa_100ns_1kHz_3V.dat"
hd[j].a_wout_baseline,  hd[j].t, _, _ = h1.__read__()
os.chdir(r"C:\Users\Davide\Documents\GitHub\UNIcodes")
...
ax.tick_params(bottom=True, top=True, left=True, right=True)
ax.tick_params(labelbottom=True, labeltop=False, labelleft=True, labelright=False)
# plt.plot(hd[j].t[0, hd[j].a_dfilt[0]<20], hd[j].a[0, hd[j].a_dfilt[0]<20], label='threshold')
plt.plot(hd[j].t[0], hd[j].a[0], label='no filter')
plt.plot(hd[j].t[0], qf[0], label='filter')
plt.axhline(y=20, c='m', linestyle='-', label='threshold')
